...
Revision: `spec-17`
Authority: epoch `tz-v24`, pinned base digest and authorized addenda in the [registry](README.md)
Status: active; 0.6.0 is the current public release and 0.4.0/0.5.0/0.6.0 artifacts are immutable; the compatible watcher repair is an unpublished 0.6.1 candidate
