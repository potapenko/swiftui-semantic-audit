...
| P18 | 0.6.1 watcher integration patch candidate | locally accepted at `2c07df251390cbda3fc3a277ce3d61fc897d4a44` and activated from receipt source `fe50f872fcaccab3a71e9402bdb4558c64f0f13b`: compatible managed timeout and selected-source config discovery, 93 XCTest plus 15 Swift Testing cases, Release binary/help, 6,286/24,551/0 indexed self-dogfood with empty diff, deterministic baselines, four validated active skills, source-built local Homebrew test, retained 0.6.0 rollback assets, docs and protected website gates; hosted CI and publication evidence remain pending |
