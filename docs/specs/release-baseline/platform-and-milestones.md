...
| P15 | 0.5.0 publication | accepted when the immutable tag/archive, tap source install, local CLI/skills, and public-site receipt in `BASE-REL-011` are terminal |
