...
Revision: `spec-17`
Status: active  
Release state: 0.6.0 is the current public release and 0.4.0/0.5.0/0.6.0 artifacts are immutable; 0.6.1 is an unpublished local candidate whose public/hosted gates remain nonterminal
