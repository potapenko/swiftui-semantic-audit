...
- Product authority: user-approved base epoch `tz-v1` plus semantic addenda through `SEMANTIC-TWIN-CAPABILITIES-001`, combined as `tz-v19`; `REALISTIC-FIXTURES-001` remains acceptance/restore evidence without its own semantic epoch.
...
- Public narrative owner: product and website contracts; the landing sells the product through its accepted capability surface with the twin as the unifying explanation, README proves it, documentation operates it, and skills consume it.
