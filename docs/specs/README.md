...
- Node type: root
- Status: Active
- Contract revision: `spec-27`
- Authority: epoch `tz-v22` and pinned digest declared below
...
Status: active  
Contract epoch: `tz-v22`
Local specification revision: `spec-27`
...
Release addendum: user-authorized [`RELEASE-0.6.0-001`](../coordination/release-0.6.0.md) on 2026-08-23; advances the combined contract to `tz-v20`; copy-control addenda: user-authorized `COPY-CONTROLS-001` and placement correction `COPY-CONTROLS-RIGHT-001` on 2026-08-23; advance the website contract through `tz-v22` without changing installation content or release facts
...
1. the user-approved ТЗ at epoch `tz-v1`, its pinned digest, the explicit addenda through `RELEASE-0.6.0-001` that advance the combined contract to `tz-v20`, and the behavior-preserving `REALISTIC-FIXTURES-001` acceptance addendum;
