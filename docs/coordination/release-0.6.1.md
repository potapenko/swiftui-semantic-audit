...
- Remaining residual: hosted CI and every push/tag/archive/tap/Homebrew install/skill activation/website deployment/publication action are intentionally absent and require separate authority.
